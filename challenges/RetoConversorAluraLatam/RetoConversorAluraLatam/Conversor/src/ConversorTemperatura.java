...
public class ConversorTemperatura {
    ...
    public void conversion(String medidaElegida, String medidaToConvertir, String conversionElegida, double valorGeneral) {
        valorTemperatura.setMedida(medidaElegida, valorGeneral);//parametro inicial para convertir
        ...
        valorTemperatura.setMedida(medidaToConvertir, totalConvertido);//parametro de temperatura convertida        
    ...
    public void eleccionMedidaTemperatura() {
        ...
        if (selectedOption != null) {//si se selecciona  funciona
